...
# Criação do gráfico
tempos = [tempo_ag, tempo_aco, tempo_tabu]
algoritmos = ['Algoritmo Genético', 'Colônia de Formigas', 'Busca Tabu']
...
for i, tempo in enumerate(tempos):
    plt.text(i, tempo + (max(tempos) * 0.05), f"{tempo:.4f}s", ha='center', fontsize=10)
