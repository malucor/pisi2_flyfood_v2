...
def realizar_experimentos_tabu(matriz_distancias, numero_experimentos=100, maximo_iteracoes=100, tamanho_tabu=5):
    resultados = []
    for _ in range(numero_experimentos):
        _, custo = busca_tabu_tsp(matriz_distancias, maximo_iteracoes, tamanho_tabu)
...
def realizar_experimentos_ag(matriz_distancias, numero_experimentos=100, tamanho_populacao=20, numero_geracoes=200, taxa_mutacao=0.02):
    resultados = []
    for _ in range(numero_experimentos):
        _, custo = algoritmo_genetico(matriz_distancias, tamanho_populacao, numero_geracoes, taxa_mutacao)
        resultados.append(custo)
    return resultados
...
melhor_solucao_conhecida = 25395

if __name__ == "__main__":
    cidades, distancias = ler_tsplib("brazil58.tsp")
